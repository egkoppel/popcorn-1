...
namespace memory::paging {
	...
	template<> class PageTableIndex<1> : public detail::PageTableIndex<512> { using detail::PageTableIndex<512>::PageTableIndex; };
	template<> class PageTableIndex<2> : public detail::PageTableIndex<512> { using detail::PageTableIndex<512>::PageTableIndex; };
	template<> class PageTableIndex<3> : public detail::PageTableIndex<512> { using detail::PageTableIndex<512>::PageTableIndex; };
	template<> class PageTableIndex<4> : public detail::PageTableIndex<512> { using detail::PageTableIndex<512>::PageTableIndex; };
