...
public:
	...
	constexpr vector(size_type count, const T& value) : buffer_start_(nullptr), buffer_end_(nullptr), item_count_(0) {
	...
	vector(InputIt begin, InputIt end)
		...
		: buffer_start_(nullptr), buffer_end_(nullptr), item_count_(0) {
	...
	constexpr const_iterator cend() const noexcept { return const_iterator(this->buffer_start_); }

	constexpr reverse_iterator rbegin() noexcept { return reverse_iterator(this->buffer_start_); }
	constexpr reverse_iterator rend() noexcept { return reverse_iterator(this->buffer_start_ + this->size()); }
	...
	constexpr const_reverse_iterator crbegin() const noexcept { return const_reverse_iterator(this->buffer_start_); }
	constexpr const_reverse_iterator crend() const noexcept { return const_reverse_iterator(this->buffer_start_); }

	constexpr reference front() { return *this->buffer_start_; }
	constexpr reference back() { return *(this->buffer_start_ + this->size()); }
