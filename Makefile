...
CFLAGS = $(INCLUDE) -MMD -MP -c -g -nostdlib -fno-exceptions -fno-rtti -fno-stack-protector -ffreestanding -target x86_64-unknown-none-elf -msse2 -mno-sse3 -mno-sse4 -mno-avx -mno-red-zone
CXXFLAGS = -std=c++20
QEMU_ARGS ?=
